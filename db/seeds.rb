...
Task.create({title: "SAT Preparation", description: "You will get a 1600 or a full refund (minimum 40 hours)", imageurl: "http://res.cloudinary.com/dsaxhw9ii/image/upload/v1484909382/db-aol-1999-web1-articleLarge_c3bml0.jpg" })
Task.create({title: "Chemistry Tutoring", description: "Anyone interested in becoming a character in the show Breaking Bad is encouraged to take this", imageurl: "http://res.cloudinary.com/dsaxhw9ii/image/upload/v1484909382/db-aol-1999-web1-articleLarge_c3bml0.jpg" })
